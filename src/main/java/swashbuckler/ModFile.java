...
import swashbuckler.cards.cardvars.AbstractEasyDynamicVariable;
import swashbuckler.potions.AbstractEasyPotion;
import swashbuckler.relics.AbstractEasyRelic;
import swashbuckler.util.ProAudio;
...
public class ModFile implements
    ...
    public static final String modID = "swashbuckler"; //TODO: Change this.
    ...
    public ModFile() {
        ...
        BaseMod.addColor(CharacterFile.Enums.SWASHBUCKLER_COLOR, characterColor, characterColor, characterColor,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new CharacterFile(CharacterFile.characterStrings.NAMES[1], CharacterFile.Enums.THE_SWASHBUCKLER),
            CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, CharacterFile.Enums.THE_SWASHBUCKLER);
    ...
    public void receiveEditKeywords() {
        ...
        BaseMod.addKeyword(new String[]{"plunder"}, "Exhaust a treasure to change this card's effect.");
        BaseMod.addKeyword(new String[]{"bleed"}, "Bled enemies take additional damage from attacks.");
    }
}
