...
import swashbuckler.util.CardArtRoller;

import static swashbuckler.ModFile.makeImagePath;
import static swashbuckler.ModFile.modID;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, CharacterFile.Enums.SWASHBUCKLER_COLOR);
    }
