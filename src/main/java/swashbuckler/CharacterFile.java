...
import swashbuckler.cards.Brace;
import swashbuckler.cards.Defend;
import swashbuckler.cards.Strike;
import swashbuckler.cards.Pillage;
import swashbuckler.cards.uncommon.*;
import swashbuckler.relics.GoldenSkull;

import java.util.ArrayList;

import static swashbuckler.CharacterFile.Enums.SWASHBUCKLER_COLOR;
import static swashbuckler.ModFile.*;

public class CharacterFile extends CustomPlayer {

    static final String ID = makeID("TheSwashbuckler");
    ...
    public static class Enums {
        ...
        public static AbstractCard.CardColor SWASHBUCKLER_COLOR;
        @SpireEnum(name = "TODO_COLOR")
